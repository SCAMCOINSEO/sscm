...
function updateStaking() {
    ...
    stakingButton.querySelector('span').textContent = stakingEarnings;
}

// Открытие модального окна стейкинга
function openStakingModal() {
    stakingModal.style.display = 'block';
}

// Показ анимации заработка
...
// Клик по кнопке кликера
clickerButton.addEventListener('click', () => {
    score++;
    updateScore();
});

// Клик по кнопке пасса
passButton.addEventListener('click', () => {
    passModal.style.display = 'block';
});

// Закрытие модального окна пасса
closePassModal.addEventListener('click', () => {
    passModal.style.display = 'none';
});

// Зажатие кнопки стейкинга для открытия окна
...
// Закрытие модального окна стейкинга
